...
[@fig:matching_fff]B, Movie 1, Movie 2). Furthermore, the side views indicated that lamellae were thinner at the leading edge. To confirm this we estimated the ice thickness in individual tiles using the Beer-Lambert law [@doi:10.1016/j.jsb.2018.06.007] using 322 nm as coefficient [@doi:10.1016/j.jsb.2018.06.007] (Fig. [@fig:lamella_motion_thickness]B). Indeed, we found that the thickness of the lamella varied between 100 and 250 nm, with consistently thinner ice at the leading edge even though we prepared the lamellae
...
It is possible that this is caused by radiation damage during FIB-milling and
...
the lamellae can be skewed by a change in thickness and radiation damage. Therefore, better sample
