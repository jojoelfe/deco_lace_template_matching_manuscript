...
package [@doi:10.7717/peerj.453] was used to calculate refined offsets $\mathbf{r}_{i,j}$. Refined coordinates $\mathbf{d}_{i}$ were then derived by least-square minimization with regard of the refine offsets:
