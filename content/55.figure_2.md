...
\node[labelNode] {A};
\node[graphicNode] (img) {\includegraphics[height=6.0cm,trim=0.0 0 1cm 0, clip]{content/images/euc_lamella1_view_morph.png}};
...
\node[labelNode] {B};
\node[graphicNode] (img) {\includegraphics[height=6.0cm,trim=0 0 1cm 0, clip]{content/images/euc_lamella1_1000px.png}};
...
\node (rect) at (6.52,10.88) [anchor=center,draw,thick,minimum width=0.3cm,minimum height=0.375cm,color=red] {};

\node (anchor) at (10.5,13.0) {}; 
\node[labelNode] {C};
% height is 750 nm
...
\node[labelNode] {D};
\node[graphicNode] (img) {\includegraphics[height=6.0cm,trim=0 0 1cm 0, clip]{content/images/fff_lamella4_view_morphed.png}};
\node[anchor=center,align=center] at ([shift={(0.0cm,0.6cm)}]img.north) {\baselineskip=8pt  \\ 38Å pixel size \\ 300μm defocus};

\node (anchor) at (5.5,5.0) {}; 
\node[labelNode] {E};
\node[graphicNode] (img) {\includegraphics[height=6.0cm,trim=0 0 1cm 0, clip]{content/images/fff_lamella4_1000px.png}};
...
\node (rect) at (8.238,3.83) [anchor=center,draw,thick,minimum width=0.3cm,minimum height=0.375cm,color=red] {};

\node (anchor) at (10.5,5.0) {}; 
\node[labelNode] {F};
% height is 750 nm
