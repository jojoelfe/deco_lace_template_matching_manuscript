...
plotted as a function of the Beam-Image-Shift values. ](tikz:lamella_spatial_info){#fig:lamella_spatial_info tag="S2"}
...
plotted as a function of the Beam-Image-Shift values. ](tikz:lamella_motion_thickness){#fig:lamella_motion_thickness tag="S3"}
...
\node (anchor) at (0.5,29.5) {}; 
\node[labelNode] {A};
\node[graphicNode] (panel) {\includegraphics[scale=0.125]{content/images/crop_unblur_initial.png}};
\node (anchor) at ([shift={(0.0,-0.5cm)}]panel.south west) {}; 
\node[graphicNode] (panel) {\includegraphics[height=4cm]{content/code/img/crop_unblur_mip_initial_alignment.png}};
