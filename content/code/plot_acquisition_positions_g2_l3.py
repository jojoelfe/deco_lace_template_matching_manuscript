...
selected_micrographs = utils.get_data_from_db(utils.datasets[6])
print(utils.datasets[6])
...
image_cache_filename = directory / 'fff_lamella3_cache.npz'
if load_cached_images:
    ...
    corr = assemb/mask
    io.imsave(directory / 'fff_lamella3_image.tif',corr/np.max(corr),plugin='pil')
