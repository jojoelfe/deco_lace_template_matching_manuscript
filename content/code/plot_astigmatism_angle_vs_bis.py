...
for dataset in utils.datasets:
    ...
    defocus.append([[m["DEFOCUS_ANGLE"],m['IMAGE_SHIFT_X'],m['IMAGE_SHIFT_Y']] for i,m in selected_micrographs.iterrows() if m['SCORE']>0.05 and m['DETECTED_RING_RESOLUTION'] < 15])
