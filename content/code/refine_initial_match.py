...
#directory.mkdir(parents=True,exist_ok=True)
#
#pycistem.programs.refine_template.write_starfile(res_my, str(directory / "30_matches.star"))
...
pycistem.programs.refine_template.write_starfile(res_my, str(directory / "17_matches.star"))
...
pycistem.programs.refine_template.write_starfile(res_my, str(directory / "52_matches.star"))