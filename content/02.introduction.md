...
Here we apply 2DTM of the ribosome large subunit (LSU) to conditionally immortalized mouse cell line that gives rise to functional mature neutrophils [@doi:10.1016/j.cell.2016.08.057] after thinning using cryo-FIB milling. We chose these
