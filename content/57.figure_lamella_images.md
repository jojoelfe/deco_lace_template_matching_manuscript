...
![ Overview images of lamellae imaged using the DeCo-LACE approach taken at low-magnification (A) Overviews taken at low magnification (B) Overviews assembled using the DeCo-LACE approach (C) Representative examples of a class of granules containing a putatively cytosolic inclusion
