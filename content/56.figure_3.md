...
image of Lamella~EUC~ 1  taken at low magnification (B) Overview of Lamella~EUC~ 1 created by
montaging high magnification images taken with the DeCo-Lace approach (C) Zoom-in into red box in panel B. Slight beam-fringe artifacts are visible
(D)  Overview
image of Lamella~FFF~ 4  taken at low magnification (E) Overview of Lamella~FFF~ 4 created by
montaging high magnification images taken with the DeCo-Lace approach (F) Zoom-in into red box in panel E. No beam-fringe artifacts are visible ](tikz:assembly){#fig:assembly}
