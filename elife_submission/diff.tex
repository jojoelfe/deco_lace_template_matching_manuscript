...
%DIF DEL ../reviews/submitted.tex   Fri Nov  4 10:09:08 2022
%DIF ADD manuscript.tex             Mon Nov 14 10:26:11 2022
...
% Correct order of tables after \paragraph or \subparagraph %DIF > 
\usepackage{etoolbox} %DIF > 
\makeatletter %DIF > 
\patchcmd\longtable{\par}{\if@noskipsec\mbox{}\fi\par}{}{} %DIF > 
\makeatother %DIF > 
% Allow footnotes in longtable head/foot %DIF > 
\IfFileExists{footnotehyper.sty}{\usepackage{footnotehyper}}{\usepackage{footnote}} %DIF > 
\makesavenoteenv{longtable} %DIF > 
%DIF -------
\usepackage{graphicx}
\makeatletter
...
%DIF 125a135-157
 %DIF > 
%% pandoc-tablenos: required package %DIF > 
\usepackage{caption} %DIF > 
 %DIF > 
%% pandoc-tablenos: environment to disable table caption prefixes %DIF > 
\makeatletter %DIF > 
\newcounter{tableno} %DIF > 
\newenvironment{tablenos:no-prefix-table-caption}{ %DIF > 
    \let\oldthetable\thetable %DIF > 
    \let\oldtheHtable\theHtable %DIF > 
    \renewcommand{\thetable}{tableno:\thetableno} %DIF > 
    \renewcommand{\theHtable}{tableno:\thetableno} %DIF > 
    \stepcounter{tableno} %DIF > 
    \captionsetup{labelformat=empty} %DIF > 
   %DIF > 
}{ %DIF > 
    \captionsetup{labelformat=default} %DIF > 
    \let\thetable\oldthetable %DIF > 
    \let\theHtable\oldtheHtable %DIF > 
    \addtocounter{table}{-1} %DIF > 
   %DIF > 
} %DIF > 
\makeatother %DIF > 
%DIF -------
...
{[}\ref{fig:matching_fff}{]}A, \DIFdelbegin \DIFdel{Movie }\DIFdelend \DIFaddbegin \DIFadd{Fig. }{[}\DIFadd{\ref{fig:matching_euc}{]}-video }\DIFaddend 1, \DIFdelbegin \DIFdel{Movie 2}\DIFdelend \DIFaddbegin \DIFadd{Fig.
}{[}\DIFadd{\ref{fig:matching_fff}{]}-video 1}\DIFaddend ). Overlaying these positions of
...
\DIFdelbegin \DIFdel{Movie }\DIFdelend \DIFaddbegin \DIFadd{Fig. }{[}\DIFadd{\ref{fig:matching_euc}{]}-video }\DIFaddend 1, \DIFdelbegin \DIFdel{Movie 2}\DIFdelend \DIFaddbegin \DIFadd{Fig.
}{[}\DIFadd{\ref{fig:matching_fff}{]}-video 1}\DIFaddend ). Furthermore, the side views indicated that lamellae were
thinner at the leading edge. \DIFdelbegin \DIFdel{Indeed, when plotting the transmitted beam
intensities }\DIFdelend \DIFaddbegin \DIFadd{To confirm this we estimated the ice
thickness }\DIFaddend in individual tiles \DIFdelbegin \DIFdel{as a function of beam image-shift, we observed
substantially higher intensities at the leading edge }\DIFdelend \DIFaddbegin \DIFadd{using the Beer-Lambert law
}{[}\protect\hyperlink{ref-17IP4Lhz1}{18}{]} \DIFadd{with 322 nm as coefficient
}{[}\protect\hyperlink{ref-17IP4Lhz1}{18}{]} \DIFaddend (Fig.
{[}\ref{fig:lamella_motion_thickness}{]}B)\DIFdelbegin \DIFdel{, which in energy-filtered
TEM indicates a thinner sample }%DIFDELCMD < {[}\protect\hyperlink{ref-17IP4Lhz1}{18}{]}%%%
\DIFdel{. Even }\DIFdelend \DIFaddbegin \DIFadd{. We found that the thickness of the
lamellae varied between 100 and 250 nm, with consistently thinner ice at
the leading edge even }\DIFaddend though we prepared the lamellae with the
``overtilt'' approach {[}\protect\hyperlink{ref-hr3dyUeI}{19}{]}\DIFdelbegin \DIFdel{, this }\DIFdelend \DIFaddbegin \DIFadd{. To further confirm
...
estimated sample thickness (Fig. }{[}\DIFadd{\ref{fig:lamella_motion_thickness}{]}C). For
...
sub-tomogram averaging }{[}\protect\hyperlink{ref-SDMGf7aG}{20}{]}\DIFadd{. This }\DIFaddend means that
LSU \DIFdelbegin \DIFdel{densities }\DIFdelend \DIFaddbegin \DIFadd{detections }\DIFaddend across the lamellae can be skewed by a change in
thickness \DIFdelbegin \DIFdel{, and }\DIFdelend \DIFaddbegin \DIFadd{and sample damage. Therefore, }\DIFaddend better sample preparation
methods \DIFaddbegin \DIFadd{together with a better understanding of the damage to the sample
during FIB-milling }\DIFaddend are needed to \DIFdelbegin \DIFdel{generate more even samples}\DIFdelend \DIFaddbegin \DIFadd{accurately quantify molecular
...
circularized mRNAs {[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-cie13Q8F}{20}{]}%%%
\DIFdelend \DIFaddbegin \hyperlink{ref-cie13Q8F}{21}{]}\DIFaddend . While ribosomes were for the most
...
\DIFdelbegin \DIFdel{exlusively }\DIFdelend \DIFaddbegin \DIFadd{exclusively }\DIFaddend at the top or bottom of the lamella. This is consistent with
...
tomography. Peck et al. {[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-1GPPSX111}{21}{]} %%%
\DIFdelend \DIFaddbegin \hyperlink{ref-1GPPSX111}{22}{]} \DIFaddend and Yang et al.
{[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-ujizcpVn}{22}{]} %%%
...
{[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-1Gwx5ScUa}{23}{]} %%%
\DIFdelend \DIFaddbegin \hyperlink{ref-1Gwx5ScUa}{24}{]} \DIFaddend and Eisenstein et al.
{[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-xvouNMBy}{24}{]} %%%
...
{[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-kncnYGLD}{25}{]}%%%
...
exosomes {[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-agVdpX76}{26}{]}%%%
...
no beam image-shift. This is \DIFdelbegin \DIFdel{in contrast to reports in single-particle analysis
(SPA) }\DIFdelend \DIFaddbegin \DIFadd{unexpected because beam image-shift is
...
}\DIFaddend {[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-44fG6kcy}{27}{]} %%%
\DIFdel{where the induced beam tilt substantially reduced the resolution if it was not corrected during processing. It is possible that }\DIFdelend \DIFaddbegin \hyperlink{ref-44fG6kcy}{28}\DIFadd{,}\protect\hyperlink{ref-wy8cRzrH}{29}{]}\DIFadd{. The
signal detected by }\DIFaddend 2DTM \DIFdelbegin \DIFdel{is less sensitive to beam-tilt aberrations, since the }\DIFdelend \DIFaddbegin \DIFadd{is target and sample dependent and has been
shown to be sensitive to a resolution up to 3 Å, but in practice is
limited by the B-factor applied to the }\DIFaddend template
\DIFdelbegin \DIFdel{is free of any aberration and only the image is distorted, while in SPA the beam tilt will affect both the images and }\DIFdelend \DIFaddbegin {[}\protect\hyperlink{ref-Ynb3IP6I}{7}{]}\DIFadd{. In our case, we used a structure of the
...
}{[}\protect\hyperlink{ref-wy8cRzrH}{29}{]}\DIFadd{. We therefore expect a worst-case
beam-tilt of 1.75 mrad. At this beam-tilt we expect a phase error of
larger than π/4 at resolutions higher than 5.75 Å
}{[}\protect\hyperlink{ref-wy8cRzrH}{29}{]}\DIFadd{, which exceeds the resolution of our
...
\DIFadd{We used 2DTM of }\DIFaddend the \DIFdelbegin \DIFdel{reconstructed template}\DIFdelend \DIFaddbegin \DIFadd{ribosome LSU to verify the image quality of
...
protein }{[}\protect\hyperlink{ref-13fhsbtxo}{30}{]} \DIFadd{may mean that a biomolecular complex of equal
...
simulations of 2DTM }{[}\protect\hyperlink{ref-Ynb3IP6I}{7}{]} \DIFadd{suggest that it should be
...
targets that can be detected}\DIFaddend .
...
using methods like WAFFLE {[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-17H2LWiIu}{28}{]} %%%
\DIFdelend \DIFaddbegin \hyperlink{ref-17H2LWiIu}{31}{]} \DIFaddend might allow
...
would be required for a 100 lamellae dataset. \DIFaddbegin \DIFadd{It might be possible to
...
\DIFaddbegin \hypertarget{key-resources-table}{%
...
\DIFadd{Source or reference
}\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\DIFadd{Identifiers
}\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\DIFadd{Additional Information
}\end{minipage} \\
\midrule()
\endhead
\DIFadd{cell line (}\emph{\DIFadd{mus
musculus}}\DIFadd{) }& \DIFadd{ER-HoxB8 }& {[}\protect\hyperlink{ref-1B9Vt9eYu}{10}{]} & & \DIFadd{Generated from mouse bone marrow as
described in
}{[}\protect\hyperlink{ref-1B9Vt9eYu}{10}{]} \\
\DIFadd{peptide, recombinant protein }& \DIFadd{SCF }& {[}\protect\hyperlink{ref-1B9Vt9eYu}{10}{]} & & \DIFadd{Generated from CHO-SCF cell line as
described in
}{[}\protect\hyperlink{ref-1B9Vt9eYu}{10}{]} \\
\DIFadd{chemical compound,
drug }& \DIFadd{Estrogen }& \DIFadd{Sigma }& \DIFadd{E8875 }& \\
\bottomrule()
\end{longtable}

\end{tablenos:no-prefix-table-caption}

\DIFaddend \hypertarget{grid-preparation}{%
\subsubsection{Grid preparation}\label{grid-preparation}}

ER-HoxB8 cells were \DIFaddbegin \DIFadd{generated as described by Wang et. al.
}{[}\protect\hyperlink{ref-1B9Vt9eYu}{10}\DIFadd{,}\protect\hyperlink{ref-nSMAxqTD}{32}{]}
\DIFadd{and }\DIFaddend maintained in RPMI medium supplemented with 10\% FBS,
penicillin/streptomycin, SCF, and estrogen
 \DIFdelbegin %DIFDELCMD < {[}\protect\hyperlink{ref-1B9Vt9eYu}{10}{]} %%%
\DIFdelend at 37 °C and 5\% CO2. 120 h prior to grid preparation, cells were washed twice in PBS and
cultured in the same medium except without estrogen. \DIFdelbegin \DIFdel{Differentiation }\DIFdelend \DIFaddbegin \DIFadd{The authenticity of the
cells }\DIFaddend was verified by \DIFdelbegin \DIFdel{staining with Hoechst-dye and inspection of nuclear morphology}\DIFdelend \DIFaddbegin \DIFadd{flow-cytometry and Giemsa staining after differentiation }{[}\protect\hyperlink{ref-1B9Vt9eYu}{10}\DIFadd{,}\protect\hyperlink{ref-nSMAxqTD}{32}{]}\DIFaddend . Cells were then counted and diluted to \(1\cdot10^6\)
...
SerialEM {[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-19ZFerhph}{29}{]} %%%
...
\DIFdelbegin \DIFdel{\(\sqrt{3}\cdot425\) nm }\DIFdelend \DIFaddbegin \DIFadd{\(\sqrt{3}\cdot 0.95 \cdot r\) }\DIFaddend horizontal spacing and
\DIFdelbegin \DIFdel{\(3/4\cdot 850\) nm vertical spacing. }\DIFdelend \DIFaddbegin \DIFadd{\(3/2\cdot 0.95 \cdot r\) vertical spacing, where \(r\) is the radius of the
...
and 12.9 \% for the eucentric focus condition. }\DIFaddend Exposures were taken at
...
below was performed using \emph{cis}TEM {[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-MUY42yxp}{30}{]}%%%
...
version of the unblur program {[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-1G4Y94qCy}{31}{]}
%DIFDELCMD < %%%
...
{[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-n43f3Sqs}{32}{]}%%%
...
implemented in \emph{cis}TEM {[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-q2PSamkS}{33}{]}%%%
...
package {[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-stvWEJeu}{34}{]} %%%
...
using the scipy package {[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-8Miti2Gz}{35}{]}%%%
...
Images were rendered using UCSF ChimeraX {[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-cYCuuZxG}{36}{]} %%%
...
deposited in EMPIAR under accession code \DIFdelbegin %DIFDELCMD < {[}%%%
\DIFdel{will be inserted}%DIFDELCMD < {]}%%%
...
using the manubot package {[}\protect\DIFdelbegin %DIFDELCMD < \hyperlink{ref-YuJbg3zO}{37}{]} %%%
...
\DIFdelbegin %DIFDELCMD < \begin{fignos:tagged-figure}[2 - figure supplement 1]
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{fignos:tagged-figure}[1 - figure supplement 1]
\DIFaddend 
...
\DIFdelbegin %DIFDELCMD < \begin{fignos:tagged-figure}[3 - figure supplement 1]
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{fignos:tagged-figure}[2 - figure supplement 1]
\DIFaddend 
...
\DIFdelbegin %DIFDELCMD < \begin{fignos:tagged-figure}[4 - figure supplement 1]
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{fignos:tagged-figure}[3 - figure supplement 1]
\DIFaddend 

\begin{figure}
\DIFdelbeginFL %DIFDELCMD < \hypertarget{fig:crop_unblur}{%
%DIFDELCMD < \centering
%DIFDELCMD < \includegraphics{figures/crop_unblur.png}
%DIFDELCMD < \caption{Motion correction of movies with condensed beams.
%DIFDELCMD < At the top of each panel is an average of the movie that was motion-corrected
%DIFDELCMD < with a red dashed box indicating the region that was used to estimate shifts.
%DIFDELCMD < Below is a graph indicating the estimated shifts of the individual frames of the
%DIFDELCMD < movie. Below this is the MIP of 2DTM using the large subunit of the mouse ribosome.
%DIFDELCMD < (A) Motion correction of the whole movie
%DIFDELCMD < (B) Notion correction of a cropped region of the movie that eliminates the beam
%DIFDELCMD < edges
%DIFDELCMD < (C) Motion correction of the whole movie, using only the central region to
%DIFDELCMD < estimate the shifts}\label{fig:crop_unblur}
%DIFDELCMD < }
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \hypertarget{fig:crop_unblur}{%
\centering
\includegraphics[width=\textwidth,height=18cm]{figures/crop_unblur.png}
...
\DIFdelbegin %DIFDELCMD < \begin{fignos:tagged-figure}[4 - figure supplement 2]
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{fignos:tagged-figure}[3 - figure supplement 2]
\DIFaddend 

\begin{figure}
\DIFdelbeginFL %DIFDELCMD < \hypertarget{fig:lamella_motion_thickness}{%
%DIFDELCMD < \centering
%DIFDELCMD < \includegraphics{figures/lamella_motion_thickness.png}
%DIFDELCMD < \caption{Motion correction of individual tiles imaged using the DeCo-LACE approach
%DIFDELCMD < (A) Total estimated motion of individual micrographs taken using the DeCo-LACE approach
%DIFDELCMD < plotted as a function of the beam image-shift values.
%DIFDELCMD < (B) Electron intensity of individual micrographs taken using the DeCo-LACE approach
%DIFDELCMD < plotted as a function of the beam image-shift values.}\label{fig:lamella_motion_thickness}
%DIFDELCMD < }
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \hypertarget{fig:lamella_motion_thickness}{%
\centering
\includegraphics[width=\textwidth,height=20cm]{figures/lamella_motion_thickness.png}
...
\DIFdelbegin %DIFDELCMD < \begin{fignos:tagged-figure}[4 - figure supplement 3]
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{fignos:tagged-figure}[3 - figure supplement 3]
\DIFaddend 
...
\DIFdelbegin %DIFDELCMD < \begin{fignos:tagged-figure}[4 - figure supplement 4]
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{fignos:tagged-figure}[3 - figure supplement 4]
\DIFaddend 
...
\DIFdelbegin %DIFDELCMD < \begin{fignos:tagged-figure}[Movie 1]
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{fignos:tagged-figure}[Figure 4-video 1]
\DIFaddend 

\begin{figure}
\DIFdelbeginFL %DIFDELCMD < \hypertarget{fig:movie1}{%
%DIFDELCMD < \centering
%DIFDELCMD < \includegraphics{images/1x1-00000000.png}
%DIFDELCMD < \caption{Movie of detected LSU targets in Lamella\(_\textrm{EUC}\) 1, corresponding to Figure 5}\label{fig:movie1}
%DIFDELCMD < }
%DIFDELCMD < %%%
...
\DIFdelbegin %DIFDELCMD < \begin{fignos:tagged-figure}[Movie 2]
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \begin{fignos:tagged-figure}[Figure 5-video 1]
\DIFaddend 

\begin{figure}
\DIFdelbeginFL %DIFDELCMD < \hypertarget{fig:movie2}{%
%DIFDELCMD < \centering
%DIFDELCMD < \includegraphics{images/1x1-00000000.png}
%DIFDELCMD < \caption{Movie of detected LSU targets in Lamella\(_\textrm{FFF}\) 4, corresponding to Figure 6}\label{fig:movie2}
%DIFDELCMD < }
%DIFDELCMD < %%%
...
\CSLLeftMargin{13. }%
\DIFdelbegin %DIFDELCMD < \CSLRightInline{\textbf{\textless i\textgreater In situ\textless/i\textgreater{} single particle classification reveals distinct 60S maturation intermediates in cells}
%DIFDELCMD < \CSLBlock{Bronwyn A Lucas, Kexin Zhang, Sarah Loerch, Nikolaus Grigorieff} \emph{Cold Spring Harbor Laboratory} (2022-04-10) \url{https://doi.org/gp4qrx}
%DIFDELCMD < \CSLBlock{DOI: \href{https://doi.org/10.1101/2022.04.10.487797}{10.1101/2022.04.10.487797}}}
%DIFDELCMD < %%%
...
\leavevmode\vadjust pre{\DIFdelbegin %DIFDELCMD < \hypertarget{ref-cie13Q8F}{}%%%
...
\leavevmode\vadjust \DIFadd{pre}{\hypertarget{ref-cie13Q8F}{}}%DIF > 
...
\DIFdelbegin %DIFDELCMD < \CSLRightInline{\textbf{Shedding light on the cell biology of extracellular vesicles}
%DIFDELCMD < \CSLBlock{Guillaume van Niel, Gisela D\textquotesingle Angelo, Graça Raposo} \emph{Nature Reviews Molecular Cell Biology} (2018-01-17) \url{https://doi.org/gct4df}
%DIFDELCMD < \CSLBlock{DOI: \href{https://doi.org/10.1038/nrm.2017.125}{10.1038/nrm.2017.125} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/29339798}{29339798}}}
%DIFDELCMD < %%%
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-wy8cRzrH}{}}%DIF > 
...
\leavevmode\vadjust \DIFadd{pre}{\hypertarget{ref-13fhsbtxo}{}}%DIF > 
...
\leavevmode\vadjust pre{\DIFaddbegin \hypertarget{ref-nSMAxqTD}{}}%DIF > 
...
\DIFdelbegin %DIFDELCMD < \CSLRightInline{\textbf{\textless scp\textgreater UCSF ChimeraX\textless/scp\textgreater{}
%DIFDELCMD < : Structure visualization for researchers, educators, and developers}
%DIFDELCMD < \CSLBlock{Eric F Pettersen, Thomas D Goddard, Conrad C Huang, Elaine C Meng, Gregory S Couch, Tristan I Croll, John H Morris, Thomas E Ferrin} \emph{Protein Science} (2020-10-22) \url{https://doi.org/ghr6mn}
%DIFDELCMD < \CSLBlock{DOI: \href{https://doi.org/10.1002/pro.3943}{10.1002/pro.3943} · PMID: \href{https://www.ncbi.nlm.nih.gov/pubmed/32881101}{32881101} · PMCID: \href{https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7737788}{PMC7737788}}}
%DIFDELCMD < %%%
