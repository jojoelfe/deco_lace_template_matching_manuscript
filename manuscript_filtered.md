...
header-includes: |
  ...
  `<link rel="alternate" type="text/html" href="https://jojoelfe.github.io/deco_lace_template_matching_manuscript/v/38fd04bb92cfffb0ea0e0e112da741a0da4b716a/" />`{=html}
  ```{=html}
...
circle-circle intersection due to radiation damage from previous exposures.](figures/matching_stat.png){#fig:matching_stat}
...
enclosed in a less electron dense inclusion in a granule(F).](figures/matching_euc.png){#fig:matching_euc}
...
to SNR and other ribosomes colored in grey.](figures/matching_fff.png){#fig:matching_fff}
