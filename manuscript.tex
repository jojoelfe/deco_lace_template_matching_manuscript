...
This manuscript
(\href{https://jojoelfe.github.io/deco_lace_template_matching_manuscript/v/56ce938e8d7fb4ca49b0ca90d4ceca7386ae3b0f/}{permalink})
was automatically generated
from \href{https://github.com/jojoelfe/deco_lace_template_matching_manuscript/tree/56ce938e8d7fb4ca49b0ca90d4ceca7386ae3b0f}{jojoelfe/deco\_lace\_template\_matching\_manuscript@56ce938}
on April 7, 2022.
...
number of matches, In some areas we found only \textasciitilde{} 50 matches er image area, while
...
as described above (Figure \ref{fig:matching} A+G). The resulting montages reveal
...
\caption{This is an example-figurern}\label{fig:matching_stat}
}
\end{figure}
...
\caption{Template matching in lamella imaged using the DeCo-Lace approach at eucentric focus}\label{fig:matching_euc}
}
\end{figure}
...
\caption{This is an example-figurern}\label{fig:matching_fff}
}
\end{figure}
