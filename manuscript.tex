...
This manuscript
(\href{https://jojoelfe.github.io/deco_lace_template_matching_manuscript/v/26bf17f811e80363e8f38656b89bbae2c14147f8/}{permalink})
was automatically generated
from \href{https://github.com/jojoelfe/deco_lace_template_matching_manuscript/tree/26bf17f811e80363e8f38656b89bbae2c14147f8}{jojoelfe/deco\_lace\_template\_matching\_manuscript@26bf17f}
on May 27, 2022.
...
We used an atomic model of the 60S mouse ribosomal subunit (6SWA) for 2DTM {[}\protect\hyperlink{ref-sbkam02a}{13}{]}. In a
...
during the data collection {[}\protect\hyperlink{ref-APSL9LmU}{14}{]}, we opted to not use these approaches in our
...
density inside the the surrounding cytosol {[}\protect\hyperlink{ref-xE2EhAcH}{15}{]}, seemed to contain a membrane-enclosed inclusion with density similar to
...
these dimensions the granules are either azurophil or specific granules {[}\protect\hyperlink{ref-xE2EhAcH}{15}{]}. To our
...
TEM indicates a thinner sample {[}\protect\hyperlink{ref-17IP4Lhz1}{16}{]}. Even though we prepared the lamellae
with the ``overtilt'' approach {[}\protect\hyperlink{ref-hr3dyUeI}{17}{]}, this means that ribosome densities across
...
circularized mRNAs {[}\protect\hyperlink{ref-cie13Q8F}{18}{]}. While ribosomes were for the most part excluded
...
astigmatism or beam tilt {[}\protect\hyperlink{ref-APSL9LmU}{14}{]}. We reasoned that if
...
establish fringe-free conditions, the ``Fine eucentric'' procedure of SerialEM {[}\protect\hyperlink{ref-19ZFerhph}{28}{]} was
...
Motion-correction, dose weighting and other preprocessing as detailed below was performed using \emph{cis}TEM {[}\protect\hyperlink{ref-MUY42yxp}{29}{]}. To avoid influence of the beam-edge on motion-correction, only a quarter of the
...
area. A custom version of the unblur program {[}\protect\hyperlink{ref-1G4Y94qCy}{30}{]}
...
{[}\protect\hyperlink{ref-n43f3Sqs}{31}{]}, searching between 0.2 and 2 μm defocus.
...
{[}\protect\hyperlink{ref-q2PSamkS}{32}{]}. The
...
package {[}\protect\hyperlink{ref-stvWEJeu}{33}{]} was used to calculate refined offsets . The coordinates \(\mathbf{c}_{i}\) were then refined by a least-square minimization against \(\mathbf{r}_{i,j}\):

\[ \displaystyle{\min_{\mathbf{c}} \sum_{pairs}{(\mathbf{r}_{i,j} - (\mathbf{c}_i-\mathbf{c}_j))^2}}\]

using the scipy package {[}\protect\hyperlink{ref-8Miti2Gz}{34}{]}. The masked cross-correlation and the least-square minimization was repeated once more to arrive at the final tile alignment.
...
Images were rendered using UCSF ChimeraX {[}\protect\hyperlink{ref-cYCuuZxG}{35}{]} using a custom extension to render 2DTM results available at {[}https://github.com/jojoelfe/tempest{]}. The Python scripts used for data processing are available
under {[}https://github.com/jojoelfe/deco\_lace\_template\_matching\_manuscript{]}.
